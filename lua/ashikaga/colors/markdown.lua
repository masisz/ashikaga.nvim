...
function M.setup()
	...
	util.highlight("RenderMarkdownInfo", { fg = color.ask.sky })
	util.highlight("RenderMarkdownHint", { fg = color.ask.icho_green })
	util.highlight("RenderMarkdownWarn", { fg = color.ask.omugi_gold })
	util.highlight("RenderMarkdownError", { fg = color.ask.orihime_red })
